...
object DatabaseModule {
    ...
    @Provides
    fun provideBookmarkRepository(db: AppDatabase, session: UserSession): BookmarkRepository = BookmarkRepositoryImpl(
        db.bookmarkDao(),
        db.folderDao(),
        session,
    )
    ...
    @Provides
    @Singleton
    fun provideMenuRepository(api: MenuApi, menuDao: MenuDao): MenuRepository = MenuRepositoryImpl(api, menuDao)
