...
internal fun readerPalette(bg: ReaderSettingsRepository.ReaderBackground): ReaderPalette {
    ...
    return when (bg) {
        ReaderSettingsRepository.ReaderBackground.Sepia -> ReaderPalette(
            "sepia-light",
            "#F5ECD9",
            "#3A2F22",
            "#6E5A43",
        ...
        ReaderSettingsRepository.ReaderBackground.Paper -> ReaderPalette(
            "paper-light",
            "#FCFCF7",
            "#21211C",
            "#5E5E57",
        ...
        ReaderSettingsRepository.ReaderBackground.Gray -> ReaderPalette(
            "gray-light",
            "#F1F3F4",
            "#202124",
            "#5F6368",
        ...
        ReaderSettingsRepository.ReaderBackground.Slate -> ReaderPalette(
            "slate",
            "#2B2F36",
            "#E8EAED",
            "#B0B6BC",
        ...
        ReaderSettingsRepository.ReaderBackground.Charcoal -> ReaderPalette(
            "charcoal",
            "#1F2328",
            "#E6E6E6",
            "#9EA7B3",
        ...
        ReaderSettingsRepository.ReaderBackground.Olive -> ReaderPalette(
            "olive",
            "#3A3F2B",
            "#F1F3E6",
            "#C2C7B0",
        ...
        ReaderSettingsRepository.ReaderBackground.Night -> ReaderPalette(
            "night",
            "#000000",
            "#E6E6E6",
            "#9E9E9E",
